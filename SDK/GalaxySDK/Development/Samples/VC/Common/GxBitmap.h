...
public:
	...
	void ShowAfterImprovment(GX_FRAME_DATA* pFrame, int64_t i64ColorCorrection
	 ...
	 /// 存储Raw图像
	 void SaveRaw(void* pRawBuffer, int32_t nImgSize, const char* pFilePath);
...
private:
	...
	///获取转换的目标8位像素格式
	GX_PIXEL_FORMAT_ENTRY GetConvertDest8BitPixelFormat(GX_PIXEL_FORMAT_ENTRY nPixelFormat) const;
