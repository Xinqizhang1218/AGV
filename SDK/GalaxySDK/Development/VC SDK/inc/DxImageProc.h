...
#   define DECOMPRESSION_DECLARE_HANDLE(name) \
    struct name##_; typedef struct name##_ *name

DECOMPRESSION_DECLARE_HANDLE(DX_DECOMPRESSION_HANDLE);
        ...
        3.Packed conversion(GVSP)
         a. input image format  GX_PIXEL_FORMAT_MONO10_PACKED GX_PIXEL_FORMAT_MONO12_PACKED 
            ...
            output image format GX_PIXEL_FORMAT_MONO8 GX_PIXEL_FORMAT_MONO10 GX_PIXEL_FORMAT_MONO12 GX_PIXEL_FORMAT_MONO16 GX_PIXEL_FORMAT_RGB8 GX_PIXEL_FORMAT_BGR8
                                GX_PIXEL_FORMAT_RGB16 GX_PIXEL_FORMAT_BGR16
        ...
        4.Packed conversion(PFNC)
         a. input image format  GX_PIXEL_FORMAT_MONO10_P GX_PIXEL_FORMAT_MONO12_P GX_PIXEL_FORMAT_MONO14_P
            ...
            output image format GX_PIXEL_FORMAT_MONO8 GX_PIXEL_FORMAT_MONO10 GX_PIXEL_FORMAT_MONO12 GX_PIXEL_FORMAT_MONO14 GX_PIXEL_FORMAT_MONO16 GX_PIXEL_FORMAT_RGB8
                                GX_PIXEL_FORMAT_BGR8 GX_PIXEL_FORMAT_RGB16 GX_PIXEL_FORMAT_BGR16
                                GX_PIXEL_FORMAT_BAYER_RG8 GX_PIXEL_FORMAT_BAYER_GR8 GX_PIXEL_FORMAT_BAYER_BG8 GX_PIXEL_FORMAT_BAYER_GB8
                                GX_PIXEL_FORMAT_BAYER_RG10 GX_PIXEL_FORMAT_BAYER_GR10 GX_PIXEL_FORMAT_BAYER_BG10 GX_PIXEL_FORMAT_BAYER_GB10
                                GX_PIXEL_FORMAT_BAYER_RG12 GX_PIXEL_FORMAT_BAYER_GR12 GX_PIXEL_FORMAT_BAYER_BG12 GX_PIXEL_FORMAT_BAYER_GB12
...
\param  pCompressionBuffer           [in]     compression buffer
\param  nCompressionSize             [in]     compression buffer size
\param  pDecompressionBuffer         [out]    decompression buffer
\param  pnDecompressionSize          [in&out] decompression buffer size
\param  emPixelFormat                [in]     pixel format
\param  nImgWidth                    [in]     image width
\param  nImgHeight                   [in]     image height
\param  nCompressionMethod           [in]     compression Method

\return emStatus
*/
//--------------------------------------------------
VxInt32 DHDECL DxDecompression(DX_DECOMPRESSION_HANDLE handle, void *pCompressionBuffer, VxInt32 nCompressionSize, void *pDecompressionBuffer, VxInt32 *pnDecompressionSize, GX_PIXEL_FORMAT_ENTRY emPixelFormat, VxUint32 nImgWidth, VxUint32 nImgHeight, VxInt32 nCompressionMethod);

//--------------------------------------------------
/**
\brief  Create handle for decompression
\param  phandle          [out] decompression handle

\return emStatus
*/
//--------------------------------------------------
VxInt32 DHDECL DxDecompressionCreate(DX_DECOMPRESSION_HANDLE *phandle);

//--------------------------------------------------
/**
\brief  Destroy handle for decompression
\param  handle          [in] decompression handle

\return emStatus
*/
//--------------------------------------------------
VxInt32 DHDECL DxDecompressionDestroy(DX_DECOMPRESSION_HANDLE handle);
